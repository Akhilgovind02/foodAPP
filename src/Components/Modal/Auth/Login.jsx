    ...
    >
      ...
      <form onSubmit={handleLogin}>
        ...
        <div className="flex items-center justify-between">
          <div
            className=" py-2 text-green-800 hover:text-green-700 flex justify-start items-center gap-2 cursor-pointer"
            onClick={() => {
              setUserExist(false);
            }}
          >
            <p className=" p-0 border-b border-green-700">Register now</p>
