    ...
    >
      ...
      <form className="" onSubmit={handleSubmit}>
        ...
        <div className="flex items-center justify-between mt-4">
          <div
            className=" py-2 text-green-800 hover:text-green-700 flex items-center justify-start gap-2 cursor-pointer"
            onClick={() => {
              setUserExist(true);
            }}
          >
            <FiArrowLeft className=" text-2xl" />
            <p className="  border-b border-green-700">Login now</p>
          </div>
